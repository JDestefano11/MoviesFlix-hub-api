...
app.post('/users/:userId/favorites', (req, res) => {
    ...
    // Sample data for testing 
    const sampleData = {
        "movieId": "123456789" // Replace this with the ID of the movie you want to add to favorites
    };
...
app.delete('/users/:userId/favorites/:movieId', (req, res) => {
    ...
    // Sample data for testing
    const sampleData = {
        "userId": "user123", // Replace this with the ID of the user whose favorites you want to modify
        "movieId": "movie456" // Replace this with the ID of the movie you want to remove from favorites
    };
...
app.delete('/users/:id/', (req, res) => {
    ...
    // Sample data for testing
    const sampleData = {
        "id": "user123" // Replace this with the ID of the user you want to delete
    };
